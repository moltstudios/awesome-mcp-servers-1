...
- <img src="https://lumnix.dev/favicon.ico" height="14" alt="Lumnix Logo" /> **[Lumnix](https://github.com/moltstudios/lumnix-mcp)** - AI-powered e-commerce research via MCP. Search Amazon, Alibaba & AliExpress for winning products, vet suppliers, and calculate FBA margins. 19 tools. Published as `lumnix`.
<br />
